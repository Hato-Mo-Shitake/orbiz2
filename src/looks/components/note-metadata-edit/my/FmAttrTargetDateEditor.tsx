import { FmAttrTargetDate } from "src/core/orb-system/services/fm-attrs/FmAttrDate";
...
export function FmAttrTargetDateEditor({
    store,
    fmAttr,
}: {
    store: StoreApi<MyNoteState>,
    fmAttr: FmAttrTargetDate,
}) {
    ...
    return (<>
        <div>
            ...
            <div>current value: {targetDate ? <DateDisplay date={targetDate} /> : "null"}</div>
            <DateTimePicker
                value={newValue}
