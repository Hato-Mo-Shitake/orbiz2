import { FmAttrDone } from "src/core/orb-system/services/fm-attrs/FmAttrDate";
...
export function FmAttrDoneEditor({
    store,
    fmAttr,
}: {
    ...
    return (<>
        <div>
            ...
            <div>current value: {done ? <DateDisplay date={done} /> : "null"}</div>
            <DateTimePicker
                value={newValue}
