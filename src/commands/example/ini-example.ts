...
const OpenSampleModalSimpleCommand = {
    ...
    callback: () => {
        // new SampleModal(OAM().OrbizPlugin.app).open();
        // new SampleModal(AM.obsidian.OrbizPlugin.app).open();
        new SampleModal(AM.obsidian.app).open();
    }
}
...
const OpenSampleModalComplexCommand = {
    ...
    checkCallback: (checking: boolean) => {
        ...
        const markdownView = AM.obsidian.workspace.getActiveViewOfType(MarkdownView);
